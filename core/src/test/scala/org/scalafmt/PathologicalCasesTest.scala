            ...
            Seq(Defn.Val(
                ...
                Defn.Def(
                    ...
                    Term.Block(
                        Seq(Defn.Var(
                                Nil,
                                Seq(Pat.Var.Term(Term.Name("state"))),
                                None,
                                Some(Term.Select(
                                        Term.Name("State"),
                                        Term.Name("start")))),
                                                                                  ...
                                                                                  Seq(Defn.Val(
                                                                                          ...
                                                                                          Term
                                                                                            .If(
                                                                                              Term
                                                                                                .Select(
                                                                                                  Term.Name("nl"), Term.Name("isDouble")),
                                                                                              Lit(
                                                                                                  "\n\n"),
                                                                                              Lit(
                                                                                                  "\n"))),
                                                                                             ...
                                                                                             Term
                                                                                               .If(Term
                                                                                                   ...
                                                                                                   Term.ApplyInfix(
                                                                                                       ...
                                                                                                       Term.Name("*"),
                                                                                                       Nil,
                                                                                                       Seq(Term.Select(Term.Name("state"), Term.Name("indentation")))))),
                                                                                      Term
                                                                                        .ApplyInfix(
                                                                                          Term.Name("newline"),
                                                                                          Term.Name("+"),
